...
\begin{frame}{Why me}
    ...
    \begin{itemize}
        ...
        \item $2014-2016$ Amazon (Dev + Ops) {\tiny oncall experience}.
...
\begin{frame}{Conclusions}
    \pause
    Devil is in the details, worth hundreds of millions of dollars. Better reuse:
    \begin{itemize}[<+(1)->]
        \item rkt
        \item runC
        \item docker
